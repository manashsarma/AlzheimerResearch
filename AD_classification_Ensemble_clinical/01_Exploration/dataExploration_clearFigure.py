...
plt.xlabel('Age of Native                    ', fontsize=15)
plt.ylabel('No of Natives                    ', fontsize=15)
plt.show()
...
plt.xticks(y_pos, objects, fontsize=12.5)
plt.ylabel('Number of natives of healthy category', fontsize=15)
plt.xlabel('Number of APOE4 gene allele in natives', fontsize=15)
plt.title('Alzimer disease sample statistics', fontsize=15)
...
plt.bar(y_pos, performance, align='center', alpha=1.0)
plt.xticks(y_pos, objects, fontsize=12.5)
plt.ylabel('Number of natives with mild cognitive issue', fontsize=15)
plt.xlabel('Number of APOE4 gene allele in natives', fontsize=15)
plt.title('Alzimer disease sample statistics', fontsize=15)
...
plt.bar(y_pos, performance, align='center', alpha=1.0)
plt.xticks(y_pos, objects, fontsize=12.5)
plt.ylabel('Number of natives of dementia category', fontsize=15)
plt.xlabel('Number of APOE4 genes in natives', fontsize=15)
plt.title('Alzimer disease sample statistics', fontsize=15)
